...
(0, config_1.subtask)(task_names_2.TASK_VERIFY_RESOLVE_ARGUMENTS)
    ...
    .setAction(async ({ address, constructorArgsParams, constructorArgs: constructorArgsModule, contract, libraries: librariesModule, listNetworks, }) => {
...
(0, config_1.subtask)(task_names_2.TASK_VERIFY_ETHERSCAN)
    ...
    .addFlag("listNetworks")
    .setAction(async ({ address, constructorArgs, libraries, contractFQN, listNetworks, }, { config, network, run }) => {
    if (listNetworks) {
